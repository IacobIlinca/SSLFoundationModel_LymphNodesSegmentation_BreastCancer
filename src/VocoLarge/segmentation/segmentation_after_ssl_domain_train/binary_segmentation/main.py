...
from src.VocoLarge.segmentation.segmentation_after_ssl_domain_train.binary_segmentation.config_binary_ssl import \
    ConfigBinarySSL
from src.VocoLarge.segmentation.segmentation_after_ssl_domain_train.binary_segmentation.train_engine import run
from src.VocoLarge.segmentation.training.visuals import save_overlay_png


def make_visuals_callback(cfg: ConfigBinarySSL):
...
def main():
    ...
    run(model, cfg, visuals_cb=visuals_cb)
